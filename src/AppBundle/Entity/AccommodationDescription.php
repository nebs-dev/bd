...
/**
 * @ORM\Table(name="accommodation_descriptions")
 * @ORM\Entity()
 */
class AccommodationDescription {
    ...
    private $id;
    /**
     * @ORM\OneToOne(targetEntity="Accommodation", mappedBy="description")
     */
     ...
     * @return AccommodationDescription
     */
    public function setAccommodations(\AppBundle\Entity\Accommodation $accommodations = null) {
